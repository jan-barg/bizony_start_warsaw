The colors and brand kit are to be followed. 

The user experience is to be simple, easy for someone non-technical.

For prompt page, backkgrond is flowy aurora, but use brand kits
## Integrate the <SoftAurora /> component from React Bits
...
Input box + mode selector, sleek and inspired by the OpenAI ChatGPT ui 