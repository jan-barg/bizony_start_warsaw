...
- `plots/price-gap-comparison.svg`: compares the complete legitimate-purchase distributions with box plots and every purchase shown as a dot; the split axis keeps the main distribution readable while retaining the full tail.
